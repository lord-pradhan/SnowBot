...
# in actual hardware replace snowbot by arduino serialisation
    def __init__(self, snowbot):
        ...
        self.x = snowbot.state.x# + np.random.normal(0, 0.0, 0)
        self.y = snowbot.state.y# + np.random.normal(0, 0.0, 0)
        self.theta = snowbot.state.theta# + np.random.normal(0, 0.00, 0)

    def measurementUpdate(self, snowbot):

        # x_obs, y_obs, theta_obs = arduino.serialisation()
        self.x = snowbot.state.x# + np.random.normal(0, 0, 0)
        self.y = snowbot.state.y# + np.random.normal(0, 0, 0)
        self.theta = snowbot.state.theta# + np.random.normal(0, 0, 0)
