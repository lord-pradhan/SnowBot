...
##        self.__write_byte(self.handle_ag, self.REG0_USER_CTRL, 0b00000000)
    ...
    def update_all(self):
        ...
        m_data = self.__read(self.handle_m, self.REGM_ST1, 9)
        ...
        self.mag_x = self.__mag_word_to_float(m_data[1:3])
        self.mag_y = self.__mag_word_to_float(m_data[3:5])
        self.mag_z = self.__mag_word_to_float(m_data[5:7])
