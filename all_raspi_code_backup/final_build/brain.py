...
class Brain:
        ...
        def initProc(self, ser, mpu, drivearduino):
...
##                        time.sleep(5)
        ...
        def driveEProc(self, ser, mpu, drivearduino):
                ...
                if self.controller.dumped_flag == 0 and self.looped > 0 and \
                np.in1d(wrappath(self.controller.gamma_prev, self.path), Path(self.snowbot,self.mark).gamma_dump):
